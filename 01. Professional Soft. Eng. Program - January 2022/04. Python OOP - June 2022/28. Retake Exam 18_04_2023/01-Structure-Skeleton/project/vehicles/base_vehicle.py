...
class BaseVehicle(ABC):
    ...
    def license_plate_number(self, value):
        ...
        self.__license_plate_number = value.strip()
    ...
    def __str__(self):
        current_status = 'OK' if not self.is_damaged else 'Damaged'
        return f'{self.brand} {self.model} License plate: {self.license_plate_number} Battery: {self.battery_level}% Status: {current_status}'